...
#include <memory>
#include "../../tilakoneRFIDDLL/engine.h"
...
QT_MOC_LITERAL(3, 30, 14) // "cardNumberRead"
...
void Engine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSignalToInterface((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->cardNumberRead(); break;
        default: ;
        }
...
// SIGNAL 0
void Engine::sendSignalToInterface(QString _t1)
{
